                ...
                <li v-for="item in cartList" :key="item.productId">
                  <div class="cart-tab-1">
                    ...
                    <div class="cart-item-pic">
                      <img v-bind:src="'/static/static/'+item.productImage" v-bind:alt="item.productName">
                    </div>
          ...
          <div class="cart-foot-wrap">
            <div class="cart-foot-inner">
              ...
              <div class="cart-foot-r">
                ...
                <div class="btn-wrap">
                  <a class="btn btn--red" :class="{'btn--dis':checkCount==0}" @click="checkout" >下一步</a>
                </div>
              </div>
            </div>
          </div>
...
export default {
    ...
    computed:{
      checkAll(){
        // if (this.checkCount==this.cartList.length) {
        //   return true
        // }
        // else{
        //   return false
    ...
    methods:{
        ...
        editCart(flag,item){
            ...
            console.log("item.pronum"+ item.productNum)
       ...
       delCartConfirm(item){   
           console.log("item "+ this.modalConfirm)
           // 点击删除图标
        this.delItem = item;
        this.modalConfirm = true;  // 模态框显示
         console.log("item2 "+ this.modalConfirm)
      },
       closeModal(){   // 关闭模态框
      ...
      toggleCheckAll(){
        ...
        axios.post('/users/check',{flag:flag}).then((response)=>{
